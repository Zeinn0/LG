...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/zeinn0/LG")
...
UPDATE = getenv("UPDATE", "UIU_II")
SUPPORT = getenv("SUPPORT", "UIU_II")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "999"))
CMD_MUSIC = list(getenv("CMD_MUSIC", ". / ! + - @ # $").split())
BG_IMG = getenv("BG_IMG", "https://telegra.ph/file/2514530559cc173845e3f.jpg")
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "6300938349").split()))
START_PIC = getenv("START_PIC", "https://telegra.ph/file/2514530559cc173845e3f.jpg")
OWNER_USERNAME = getenv("OWNER_USERNAME", "rr8r9")
IMG_1 = getenv("IMG_1", "https://graph.org/file/475127193de2444183fd4.jpg")
IMG_2 = getenv("IMG_2", "https://telegra.ph/file/2514530559cc173845e3f.jpg")
IMG_3 = getenv("IMG_3", "https://telegra.ph/file/2514530559cc173845e3f.jpg")
IMG_4 = getenv("IMG_4", "https://telegra.ph/file/2514530559cc173845e3f.jpg")
